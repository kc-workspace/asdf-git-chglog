...
KC_ASDF_NAME="asdf-git-chglog"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-git-chglog"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="git-chglog"
KC_ASDF_APP_WEBS="https://godoc.org/github.com/git-chglog/git-chglog"
KC_ASDF_APP_DESC="changelog generator implemented in Golang."
KC_ASDF_APP_REPO="https://github.com/git-chglog/git-chglog"
